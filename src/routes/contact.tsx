  ...
  head: () => ({
    meta: [
      { title: "Contact — Together We Heal" },
      {
        name: "description",
        content:
          "Book your free discovery call and begin your transformation journey.",
      },
      { property: "og:title", content: "Contact — Together We Heal" },
      {
        property: "og:description",
        content: "Get in touch — book your free consultation.",
      },
    ],
  }),
  ...
  return (
    <PageShell hideContactCTA>
      <PageHeader
        ...
        title="Contact"
        lead="Book your free discovery call today."
      />
      <section className="px-6 md:px-10 max-w-[1400px] mx-auto pb-12 grid md:grid-cols-[1.4fr_1fr] gap-5">
        <form className="rounded-3xl bg-cream-deep p-8 md:p-10 space-y-5">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              <label
                htmlFor="service"
                className="block font-mono text-[11px] text-foreground/55 mb-2"
              >
                SERVICE TYPE
              </label>
        ...
        <div className="rounded-3xl bg-foreground text-background p-8 md:p-10 flex flex-col">
          <div className="font-mono text-[11px] text-background/60 mb-6">
            QUICK CONNECT
          </div>
          ...
          <ul className="mt-10 space-y-4 text-sm border-t border-background/15 pt-6">
            <li>
              <div className="font-mono text-[11px] text-background/60 mb-1">
                EMAIL
              </div>
              <a
