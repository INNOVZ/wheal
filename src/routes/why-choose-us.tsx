  ...
  head: () => ({
    meta: [
      { title: "Why Choose Us — Together We Heal" },
      {
        name: "description",
        content:
          "Certified, personalized, confidential, holistic healing — available online and in-person across the UAE.",
      },
      { property: "og:title", content: "Why Choose Us — Together We Heal" },
      {
        property: "og:description",
        content: "Professional, compassionate healing guidance.",
      },
    ],
  }),
  component: WhyPage,
...
const reasons = [
  {
    ...
    body: "Certified Hypnosis Professional with a proven track record.",
  },
  {
    num: "02",
    title: "Personalized Sessions",
    body: "One-on-one sessions tailored to your unique needs.",
  },
  {
    num: "03",
    title: "Confidential Space",
    body: "A confidential and compassionate environment.",
  },
  {
    num: "04",
    title: "Holistic Approach",
    body: "Modern psychology combined with ancient healing.",
  },
  {
    num: "05",
    title: "Convenient Access",
    body: "Based in the UAE — available online and in-person.",
  },
  {
    num: "06",
    title: "Lasting Transformation",
    body: "Tools and rituals you carry with you long after the session ends.",
  },
];
    ...
    <PageShell>
      ...
      <div className="relative z-10">
        <PageHeader
          ...
          title="Why Us"
          lead="Experience the difference with professional, compassionate healing guidance."
        />

        {/* Chakra legend strip — no background */}
        <section className="px-6 md:px-10 max-w-[1400px] mx-auto pb-12">
          <div className="text-center">
            <div className="font-mono text-[11px] text-foreground/55 mb-5">
          ...
          {reasons.map(({ num, title, body }, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display text-3xl text-foreground mb-3 leading-[0.95]">
                  {title.toUpperCase()}
                </h3>
