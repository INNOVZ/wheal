  ...
  return (
    <section className="px-6 md:px-10 max-w-[1400px] mx-auto pt-24 md:pt-32 pb-16">
      <div className="rounded-3xl bg-foreground text-background p-8 md:p-14 grid md:grid-cols-[1.2fr_1fr] gap-10 items-center">
        <div>
          <div className="font-mono text-[11px] text-background/60 mb-5">GET IN TOUCH</div>
          ...
          <p className="mt-6 text-background/80 max-w-md leading-relaxed">
            Reach out for a free discovery call. We'll listen, hold space, and find the right path forward together.
          </p>
        </div>
        <form
          className="space-y-4"
          onSubmit={(e) => {
            ...
            const subject = encodeURIComponent("Discovery call — " + (data.get("name") ?? ""));
        ...
        >
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="Mind & Emotional Healing" className="text-foreground bg-background">Mind & Emotional Healing</option>
              <option value="Regression Therapy" className="text-foreground bg-background">Regression Therapy</option>
              <option value="Behavioral Transformation" className="text-foreground bg-background">Behavioral Transformation</option>
              <option value="Energy & Spiritual Healing" className="text-foreground bg-background">Energy & Spiritual Healing</option>
              <option value="Not sure yet" className="text-foreground bg-background">Not sure yet</option>
            </select>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Link to="/contact" className="font-mono text-[11px] text-background/70 hover:text-background underline-offset-4 hover:underline">
