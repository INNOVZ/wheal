...
export type BlogCategory = "Inner Work" | "Energy" | "Regression" | "Transformation";
...
export const posts: BlogPost[] = [
  // ============ INNER WORK ============
  {
    ...
    excerpt: "Subtle patterns in adulthood often trace back to unmet needs in childhood. Here is how to notice them.",
    image: "https://images.unsplash.com/photo-1499728603263-13726abce5fd?auto=format&fit=crop&w=1600&q=80",
    body: [
  ...
  },
  {
    ...
    excerpt: "A simple, profound exercise to begin reparenting the parts of you still waiting to be heard.",
  ...
  // ============ ENERGY ============
  {
    ...
    excerpt: "A short ritual to scan your energy centers and restore balance in under five minutes.",
    image: heroHealing,
    body: [
  ...
  },
  {
    ...
    excerpt: "Three simple techniques — water, breath, and intention — to clear absorbed energy after a long day.",
  ...
  // ============ REGRESSION ============
  {
    ...
    excerpt: "Demystifying the experience and what to expect during your first session.",
  ...
  },
  {
    ...
    excerpt: "Two doors into the subconscious — how to know which one your healing is asking for.",
    image: "https://images.unsplash.com/photo-1476611317561-60117649dd94?auto=format&fit=crop&w=1600&q=80",
    body: [
  ...
  // ============ TRANSFORMATION ============
  {
    ...
    excerpt: "Why willpower fails and how reprogramming the subconscious creates lasting change.",
  ...
  },
  {
    ...
    excerpt: "The beliefs about abundance you absorbed before age seven are still running the show. Here's how to update them.",
